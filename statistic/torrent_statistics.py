...
class torrent_statistic():
    ...
    def get_upload_statistics(self):
        upload_log  = 'uploaded : [upload rate = ' + str(self.upload_rate) + ' Kbps'
        upload_log += ', avg uploading rate = ' + str(self.avg_upload_rate) + ' Kbps'
        upload_log += ', max uploading rate = ' + str(self.max_upload_rate) + ' Kbps]'
        return upload_log